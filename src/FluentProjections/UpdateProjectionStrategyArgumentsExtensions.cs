...
namespace FluentProjections
{
    public static class UpdateProjectionStrategyArgumentsExtensions
    {
        ...
        public static UpdateProjectionStrategyArguments<TMessage, TProjection> WhenEqual<TMessage, TProjection, TValue>(
            this UpdateProjectionStrategyArguments<TMessage, TProjection> source,
        ...
        /// <summary>
        ///     Update projections that match a filter by a property from a message with the same name as in a projection.
        /// </summary>
        /// <typeparam name="TMessage">A message type</typeparam>
        /// <typeparam name="TProjection">A projection type</typeparam>
        /// <typeparam name="TValue">A type of projection property</typeparam>
