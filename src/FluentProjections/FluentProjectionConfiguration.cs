...
{
    public abstract class FluentProjectionConfiguration<TProjection>
    {
        private readonly List<IFluentEventHandlerConfiguration> _configurations = new List<IFluentEventHandlerConfiguration>();
