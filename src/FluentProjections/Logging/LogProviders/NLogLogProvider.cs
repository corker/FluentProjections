            ...
            public void Log(LogLevel logLevel, Func<string> messageFunc)
            {
                switch (logLevel)
                {
                    ...
                    case LogLevel.Fatal:
                        ...
                        break;
                    default:
                        if (IsTraceEnabledDelegate(_logger)) TraceDelegate(_logger, messageFunc());
                        break;
                }
            }
                ...
                where TException : Exception
            {
                switch (logLevel)
                {
                    ...
                    case LogLevel.Fatal:
                        ...
                        break;
                    default:
                        if (IsTraceEnabledDelegate(_logger)) TraceExceptionDelegate(_logger, messageFunc(), exception);
                        break;
                }
            }
